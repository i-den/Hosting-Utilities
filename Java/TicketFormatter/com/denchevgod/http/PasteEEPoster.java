...
public class PasteEEPoster {
    ...
    private static final String defaultPasteURL = "https://api.paste.ee/v1/pastes";

    public static String postScanOnline(InfectedUser infectedUser) throws IOException {
        ...
        arguments.put("key", (String) Config.SETTINGS.getOption("apiDevKey"));
        arguments.put("sections[0][name]", "Malware Scan - " + infectedUser.getUserName());
        arguments.put("sections[0][contents]", infectedUser.listMalwareFiles());
